...
class ImportFilterRuleDialog() : BaseDialogFragment(R.layout.dialog_recycler_view),
    ...
    private val viewModel by viewModels<ImportFilterRuleViewModel>()
    ...
    override fun onFragmentCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.toolBar.setTitle(R.string.import_filter_rule)
    ...
    override fun onCodeSave(code: String, requestId: String?) {
        requestId?.toInt()?.let {
            GSON.fromJsonObject<FilterRule>(code).getOrNull()?.let { rule ->
    ...
    inner class SourcesAdapter(context: Context) :
        RecyclerAdapter<FilterRule, ItemSourceImportBinding>(context) {
            ...
            binding.run {
                ...
                tvSourceState.text = when {
                    ...
                    item.pattern != localRule.pattern
                            || item.isRegex != localRule.isRegex -> "更新"
                    else -> "已有"
                }
            }
        }
